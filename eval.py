...
def eval(parser, dataset):
    ...
    if args.record_path is not None:
        ...
        txt = 'D:\\PythonProject\\SDRNet-main\\SDRNet-main\\metrics\\'+model_name+'.txt'
    f = open(txt, 'a')
    f.write(eval_record)
    f.write("\n")
    f.close()
model_name = 'PVTv2_MSSEP'
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("--model", default=model_name)
    parser.add_argument("--pred_root", default='D:\\PythonProject\\SDRNet-main\\SDRNet-main\\checkpoints\\PVTv2_MSSEP\\result\\'+model_name)
    parser.add_argument("--GT_root", default='D:\\PythonProject\\SDRNet-main\\SDRNet-main\\dataset2\\gjw\\TestDataset')
    parser.add_argument("--record_path", default='D:\\PythonProject\\SDRNet-main\\SDRNet-main\\metrics\\'+model_name+'.txt')
